...
/**
 * bus_server_start_with_socketpair:
 * @guid: Generated by g_dbus_generate_guid()
 * @returns: a part of socket descriptions
 *
 * Creates a pair of socket descriptions and creates a DBus connection
 * with @guid and the part of the sockets and returns the another part of
 * the socket descriptions.
 */
int          bus_server_start_with_socketpair (const gchar *guid);
