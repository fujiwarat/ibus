 ...
 * Returns: The server address, e.g.
 *      "unix:abstract=/tmp/dbus-aEUnr11L,guid=8b343aaa69eabb9b282dce6f4cdbb4aa"
 *
...
/**
 * bus_server_insert_server_with_guid:
 * @guid: A 32bit sequence generated by g_dbus_generate_guid().
 *
 * This makes a dedicated DBus address by @guid.
 * Returns: The server address by @guid.
 */
gchar *bus_server_insert_server_with_guid (const gchar *guid);
